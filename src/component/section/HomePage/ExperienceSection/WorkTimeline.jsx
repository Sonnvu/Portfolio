                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <div id="philips" class="relative pl-8 sm:pl-32 py-6 group">
                            ...
                            <div
                                ...
                                <time
                                    class="sm:absolute -left-14 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-36 h-6 mb-3 sm:mb-0 text-slate-500">Present
                                    - Aug 2023
                                </time>
